...
<!--
{
  ...
  "description": "High-performance PyTorch library for Group Relative Policy Optimization (GRPO) featuring custom fused Triton kernels with online Softmax tiling and activation recomputation.",
  "innieDescription": "Fused token-advantage optimization pipeline running custom Triton memory recomputation kernels.",
  "techStack": ["PyTorch", "Triton", "CUDA", "Python", "Transformers", "Docker"]
}
-->